...
.method public static constructor <clinit>()V
    ...
    sput-object v1, La/b/k/h;->b0:[I

    if-eqz v3, :cond_0

    sget-boolean v1, La/b/k/h;->c0:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Window;La/b/k/f;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, La/b/k/h;->s:La/g/k/o;
...
.method public final F(I)V
    ...
    invoke-static {p1, v0}, La/g/k/k;->J(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public L(I)I
    ...
    invoke-static {v5, v2, v4}, La/b/p/b1;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public h(Landroid/os/Bundle;)V
    ...
    invoke-static {v0, v2}, La/b/k/o;->x(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 10
    :pswitch_4
    invoke-virtual {p1, v2, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->a(Landroid/content/Context;Landroid/util/AttributeSet;)La/b/p/d;
    ...
    .line 12
    :pswitch_6
    invoke-virtual {p1, v2, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->d(Landroid/content/Context;Landroid/util/AttributeSet;)La/b/p/r;
    ...
    :pswitch_7
    invoke-virtual {p1, v2, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->c(Landroid/content/Context;Landroid/util/AttributeSet;)La/b/p/g;
    ...
    invoke-direct {v3, v2, p4}, La/b/p/l;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 17
    :pswitch_b
    invoke-virtual {p1, v2, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->b(Landroid/content/Context;Landroid/util/AttributeSet;)La/b/p/f;
    ...
    .line 20
    :pswitch_d
    invoke-virtual {p1, v2, p4}, Landroidx/appcompat/app/AppCompatViewInflater;->e(Landroid/content/Context;Landroid/util/AttributeSet;)La/b/p/z;
    ...
    invoke-static {v1}, La/g/k/k;->u(Landroid/view/View;)Z
...
.method public final q(Z)Z
    ...
    invoke-static {p1}, La/g/c/a;->f(Landroid/app/Activity;)V
    ...
    instance-of v3, p1, La/l/g;

    if-eqz v3, :cond_11

    move-object v3, p1

    check-cast v3, La/l/g;

    invoke-interface {v3}, La/l/g;->a()La/l/d;

    move-result-object v3

    check-cast v3, La/l/h;

    .line 8
    iget-object v3, v3, La/l/h;->b:La/l/d$b;

    .line 9
    sget-object v5, La/l/d$b;->e:La/l/d$b;
...
.method public final r(Landroid/view/Window;)V
    ...
    sget-object v2, La/b/k/h;->b0:[I

    invoke-static {v0, v1, v2}, La/b/p/x0;->p(Landroid/content/Context;Landroid/util/AttributeSet;[I)La/b/p/x0;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, La/b/p/x0;->h(I)Landroid/graphics/drawable/Drawable;
...
.method public v(Landroid/view/KeyEvent;)Z
    ...
    .line 1
    invoke-static {v0, p1}, La/g/k/k;->c(Landroid/view/View;Landroid/view/KeyEvent;)Z
...
.method public x()V
    ...
    iget-object v0, p0, La/b/k/h;->s:La/g/k/o;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, La/g/k/o;->b()V
...
.method public final y()V
    ...
    invoke-static {v0, v1}, La/g/k/k;->Z(Landroid/view/View;La/g/k/i;)V
    ...
    :cond_c
    invoke-static {v0}, La/b/p/b1;->c(Landroid/view/View;)V
